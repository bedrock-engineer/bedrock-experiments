...
def _(Draw, buffer, folium, geojson_text_area, gpd, json, site_geojson):
    ...
    folium_map
    return bounds, bounds_rectangle, folium_map, site
...
def _(mo):
    mo.md(r"""
    The bouding box around the site + buffer that we created above is now used to make a call to the BRO API to retrieve all the CPT characteristics of the CPTs in that bounding box.
    """)
    return
